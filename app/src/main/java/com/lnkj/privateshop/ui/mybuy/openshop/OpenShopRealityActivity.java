...
public class OpenShopRealityActivity extends BaseActivity implements OpenShopContract.View, View.OnClickListener {
    /**
     * s实体店
     */
    ...
    public int initContentView() {
        return R.layout.activity_open_shop_reality;
    }
    ...
    public void initInjector() {
        ...
        rootview = View.inflate(this, R.layout.activity_open_shop_reality, null);
...
//        finish();
    ...
    public void getShopInfoSucceed(EditShopBean.DataBean beans) {
        ...
        String market_name = beans.getMarket_name();
        if (!TextUtils.isEmpty( market_name)){
            etAddress.setText(market_name);
        }
        String floor_number = beans.getFloor_number();
        if (!TextUtils.isEmpty( floor_number)){
            etFloor.setText(floor_number);
        }
        String room_number = beans.getRoom_number();
        if (!TextUtils.isEmpty( room_number)){
            etNummber.setText(room_number);
        }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            if ("请点击选择".equals(tvProvin.getText().toString())){
                ...
                mPresenter.openRealityShop(path_head, path, etShipName.getText().toString(), etPeople.getText().toString(), etPhone.getText().toString(),
                        province, city, etAddress.getText().toString(), Cat_id, etMount.getText().toString(), etPackMount.getText().toString(), mswitch.isChecked(),
                        etFloor.getText().toString(),etNummber.getText().toString());
                break;
            case R.id.rl_img:
...
//                i.putExtra("type","网店");
//                startActivity(i);
                AlertDialog.Builder builder = new AlertDialog.Builder(OpenShopRealityActivity.this);
