...
public class FootPrintPresenter implements FootPrintContract.Presenter{
                ...
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String data) {
                        ...
                        int status = object.getInt("status");
                            FootPrintBean beass = JSON.parseObject(data,FootPrintBean.class);
    ...
    @Override
    public void delUserBrowse(String goods_id) {
        Map<String,Object> map = new HashMap<String, Object>();
        map.put("token",token);
        map.put("goods_id",goods_id);
        LLog.d("goods_id", goods_id);


        meApi.delUserBrowse(map)
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Action1<String>() {
                    @Override
                    public void call(String data) {
