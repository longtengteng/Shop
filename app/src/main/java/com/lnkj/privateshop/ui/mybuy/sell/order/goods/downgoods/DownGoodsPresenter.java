...
public class DownGoodsPresenter implements DownGoodsContract.Presenter {

    DownGoodsContract.View mView;
    private String token;
    public DownGoodsPresenter(DownGoodsContract.View mView) {
        this.mView = mView;
    }

    @Override
    public void attachView(@NonNull DownGoodsContract.View view) {
    ...
    @Override
    public void getDownGoodsFromServer() {
        mView.showLoading();
                    ...
                    public void call(String data) {
                        ...
                        try {
                            ...
                            if (status==1){
                                ...
                                mView.getDownGOodssucceed(beass);
                            }
