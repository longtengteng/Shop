...
public class EntityShopActivity extends BaseActivity implements ShopDataEditContract.View, View.OnClickListener{
    ...
    public int initContentView() {
        rootview = View.inflate(this, R.layout.activity_entity_shop, null);
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_submit:
                mPresenter.saveNetShopData(path, tvPeople.getText().toString(), tvPhone.getText().toString(), province, city, etAddress.getText().toString(),
                        Cat_id, tvPackMount.getText().toString(), etMount.getText().toString(), mswitch.isChecked() ? "1" : "0", tv_company_name.getText().toString()
                        , tv_company_http.getText().toString(), tv_num.getText().toString(),etContent.getText().toString(),"");
                break;
    ...
    public void getData(EditShopBean.DataBean beass) {
        ...
        tv_company_name.setText(beass.getMarket_name());
        tv_company_http.setText(beass.getFloor_number());
        tv_num.setText(beass.getRoom_number());

        tv_company_num.setText(beass.getReg_number());
        tv_license_name.setText(beass.getCompany_name());
