...
public class ShopArchivesPresenter implements ShopArchivesContract.Presenter {
   private  ShopArchivesContract.View mView ;

 private String token;
    public ShopArchivesPresenter(ShopArchivesContract.View mView) {
        this.mView = mView;

    }

    @Override
    public void attachView(@NonNull ShopArchivesContract.View view) {
 ...
 public void setToken(String token) {
  this.token = token;
    ...
    @Override
    public void getShomComment(String shopid) {
        mView.showLoading();
        Map<String,Object> map = new HashMap<String, Object>();
        map.put("token",token);
        map.put("shop_id",shopid);
