...
import static com.lnkj.privateshop.R.id.tv_phone;
import static com.lnkj.privateshop.R.id.tv_provin;

public class ShopNetActivity extends BaseActivity implements ShopDataEditContract.View,View.OnClickListener {
    ...
    public int initContentView() {
        rootview=View.inflate(this,R.layout.activity_shop_net,null);
        return R.layout.activity_shop_net;
    }
    ...
    public void onViewClicked(View view) {
        ...
        mPresenter.saveNetShopData(path,tvPeople.getText().toString(),tvPhone.getText().toString(),province,city,etAddress.getText().toString(),
                Cat_id,tvPackMount.getText().toString(),etMount.getText().toString(),mswitch.isChecked()?"1":"0","","","",etContent.getText().toString(),"");
                break;
