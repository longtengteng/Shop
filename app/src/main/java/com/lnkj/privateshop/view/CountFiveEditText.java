 ...
 * 
 */
public class CountFiveEditText extends EditText {
	...
	private int numLength = 500;
	private String numStr = "0  /" + numLength;// 咳咳，没空格字数到百位了绘制的字数统计就撮到屏幕外面去了，有更好的方式的话请指教
	private int numSize = 30;// 字数统计的大小

	public CountFiveEditText(Context context) {
		this(context, null);
	}

	public CountFiveEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		edit = this;
		// 设置最多输入的字数
