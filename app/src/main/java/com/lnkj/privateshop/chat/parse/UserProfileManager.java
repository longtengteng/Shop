package com.lnkj.privateshop.chat.parse;
...
import com.lnkj.privateshop.chat.EaseHelper;
import com.lnkj.privateshop.chat.PreferenceManager;
...
public class UserProfileManager {
	...
	public synchronized boolean init(Context context) {
		...
		syncContactInfosListeners = new ArrayList<EaseHelper.DataSyncListener>();
		sdkInited = true;
		return true;
	}

	public void addSyncContactInfoListener(EaseHelper.DataSyncListener listener) {
		if (listener == null) {
			return;
		}
	...
	public void removeSyncContactInfoListener(EaseHelper.DataSyncListener listener) {
		if (listener == null) {
			return;
		}
		if (syncContactInfosListeners.contains(listener)) {
