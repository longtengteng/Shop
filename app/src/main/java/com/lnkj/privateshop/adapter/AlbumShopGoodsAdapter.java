...
public class AlbumShopGoodsAdapter extends BaseAdapter {
    List<ShopMerchandiseListBean.DataBean.GoodsListBean> images;
    private Activity mContext;

    public AlbumShopGoodsAdapter(BaseActivity context, List<ShopMerchandiseListBean.DataBean.GoodsListBean> images) {
        this.mContext = context;
        this.images = images;

    }

    public void bindList(  List<ShopMerchandiseListBean.DataBean.GoodsListBean> images) {
        this.images = images;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (isShowAddItem(position)) {
            ...
            final ShopMerchandiseListBean.DataBean.GoodsListBean item = images.get(position);

                Glide.with(mContext).load
                        (Constants.Base_IMG_URL+ item.getGoods_img()).
