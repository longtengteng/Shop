...
public class SeachOrderListAdapter extends BaseAdapter {
    private Context mContext;
    List<SeachOrderBean.DataBean.OrderListBean.GoodsInfoBean> beans;

    public SeachOrderListAdapter(Context mContext, List<SeachOrderBean.DataBean.OrderListBean.GoodsInfoBean> beans) {
    ...
    @Override
    public SeachOrderBean.DataBean.OrderListBean.GoodsInfoBean getItem(int i) {
        return beans.get(i);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if (beans.get(i).getOrder_return_status().equals("1")){
        holder.tv_goods_return.setVisibility(View.VISIBLE);
            holder.tv_goods_return.setText("退款中");
        }else if (beans.get(i).getOrder_return_status().equals("2")){
