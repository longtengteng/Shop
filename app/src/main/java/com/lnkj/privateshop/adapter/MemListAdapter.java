...
public class MemListAdapter extends RecyclerView.Adapter<MemListAdapter.ViewHolder> {
    ...
    public MemListAdapter(Context mContext) {
        this.mContext = mContext;

    }

    public void addAllData(List<MenGoodsListBean.DataBean> beans) {
        this.beans = beans;
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tvGoodsPrice.setText("¥" + beans.get(position).getUser_price());
