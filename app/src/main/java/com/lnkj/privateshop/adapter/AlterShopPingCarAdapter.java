...
public class AlterShopPingCarAdapter extends BaseAdapter {
    Context mContext;
    int index = 0;
    List<AlterGoodsCountBean.DataBean.GoodsSpecBean> lists;
    public AlterShopPingCarAdapter(Context mContext, List<AlterGoodsCountBean.DataBean.GoodsSpecBean> lists) {
...
//        }
        ...
        int currentNumber = lists.get(i).getHas_number();
