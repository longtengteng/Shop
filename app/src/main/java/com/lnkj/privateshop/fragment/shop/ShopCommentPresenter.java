...
public class ShopCommentPresenter implements ShopCommentContract.Presenter {
 ...
 private String token;
    public ShopCommentPresenter(ShopCommentContract.View mView, Context mContext) {
        this.mView = mView;
 ...
 public void setToken(String token) {
  this.token = token;
    ...
    @Override
    public void getShomComment(String shopid,int p,String type) {
        mView.showLoading();
                ...
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String data) {
                        ...
                        try {
                            ...
                            if (status==1){
                                shopcommentBean beass = JSON.parseObject(data,shopcommentBean.class);
