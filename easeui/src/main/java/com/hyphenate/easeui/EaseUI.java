...
public final class EaseUI {
    ...
    public interface EaseUserProfileProvider {
         ...
         * @return
         */
        EaseUser getUser(String username, ImageView avaterView, TextView nickView);

        EaseUser getUser(String username);

        EMGroup getGroup(String groupId, ImageView logoView);

        EMGroup getGroup(String groupId,TextView nameView);

        EaseUser getUser(String username,String appendString,TextView nickView);
    }
